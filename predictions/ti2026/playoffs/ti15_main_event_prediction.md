...
- commit `4f29d96` | generated 2026-08-16T17:27:59+00:00 | cutoff 2026-08-16T12:00:00+00:00
...
|---|---:|---:|---:|---:|---:|---:|
| PARIVISION | **0.348** | 0.200-0.498 | 0.519 | 0.634 | 0.448 | 0.286 |
...
|---|---:|---:|
| greedy coherent favourite | 2221.7 | 5.060 |
| max E[correct] | 2287.5 | 5.118 |
| **max E[official score] (primary)** | **2287.9** | 5.108 |
...
| 802 | UBQF | PARIVISION vs BetBoom Team | **PARIVISION** | 0.636 | 0.634 | 477.5 | - |
...
| 805 | UBSF | Team Spirit vs PARIVISION | **PARIVISION** | 0.684 | 0.448 | 277.2 | - |
| 806 | UBSF | Team Yandex vs Team Falcons | **Team Falcons** | 0.514 | 0.328 | 19.3 | YES |
| 807 | UBF | PARIVISION vs Team Falcons | **PARIVISION** | 0.612 | 0.286 | 74.9 | - |
| 808 | GF | PARIVISION vs Team Falcons | **PARIVISION** | 0.639 | 0.348 | 155.9 | - |
| 809 | LBR1 | Tundra Esports vs BetBoom Team | **BetBoom Team** | 0.628 | 0.378 | 221.1 | - |
...
- second-best coherent slate: E[score] 2287.5 (regret 0.40), differs at 810 (Nigma Galaxy -> Team Liquid)
- paired resolution of that difference (40000 draws): plug-in +5.22, bootstrap mean +0.37 (MC SE 0.31), median +1.73, 95% CI [-127.1, +120.5], P(delta>0)=0.5111 -> **TIE**: the paired 95% interval spans zero and the mean difference is under 6 points, 5% of one correct node. the official-score objective still has a unique argmax, so the client pick stays the primary; the tie is a statement about evidence, not an abstention
- best slate with a different champion (Team Falcons): E[score] 2132.1 (regret 155.89)
